...
# Wait for agent 1's join confirmation before starting agent 2 -- this ordering (not a --symbol flag,
# which doesn't exist) is what makes the seat assignment deterministic: agent 1 = X, agent 2 = O.
