"""Proves the autouse conftest.py guard is active (ARENA-OPUS-OPUS-035, architecture §11): even a test
...
def test_unmocked_create_llm_client_still_gets_the_guarded_dummy() -> None:
    ...
    # The guard patches agent.llm.AsyncAnthropic, so the constructed SDK object is the patched
    # dummy's return value -- a MagicMock, never a real network-capable AsyncAnthropic.
