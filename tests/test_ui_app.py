"""Integration tests for the served app.js wiring (ARENA-OPUS-027). Served-asset level; no LLM.

The no-build UI is validated by GETting the asset and asserting its entry points and wire contract —
consistent with the vanilla-JS, no-transpile design.
"""
