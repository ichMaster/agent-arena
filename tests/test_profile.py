"""AgentProfile tests (ARENA-OPUS-OPUS-019). No LLM, no paid call (the factory tie patches the SDK)."""
...
def test_profile_drives_the_real_llm_factory() -> None:
    """The loaded profile's model_type/temperature feed create_llm_client (SDK patched, no call)."""
    profile = AgentProfile.load_from_yaml("profiles/aggressive.yml")
