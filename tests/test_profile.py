...
def test_invalid_yaml_raises(tmp_path: Path) -> None:
    ...
    with pytest.raises(Exception):  # yaml parse error surfaces
        AgentProfile.load_from_yaml(path)
...
def test_profile_drives_real_llm_factory() -> None:
