...
A bounded buffer of recent match events (moves + chat) rendered as short lines for the prompt builder
to embed. Oldest events fall off once the window is full. Pure logic — no I/O, nothing imported from
``server/``.
"""
